...
const char* const text[]=
{
	...
	[0x01B4] = "萨卡草原的女剑士，性格刚强的女中豪杰，有着冷静的洞察力，剑技相当不俗。",
//	[0x01B4] = "萨卡草原的女剑士，性格刚强的女中豪杰，有着冷静的洞察力，剑技不俗。",
...
//				"前面有座山" pushA
	...
	[0x837] = /*openLeft loadFace pCherryBlue
				openFarLeft loadFace pCherryBlue
				openRight loadFace pCherryBlue
				openFarRight loadFace pCherryBlue
				"蓝切尔利头像测试" pushA
				clearFace,*/
				openRight loadFace pCherryRed "红切尔利头像测试" pushA clearFace,
};
